 ...
 *         => 키워드는 사용금지
 *         => 공백 금지
 *      => 관련된 클래스를 모아서 관리 => 폴더(패키지)
 *      => 재사용
 *      => 잘 만든 클래스 => .jar
 *      => 클래스 => 여러개 묶는다 => 패키지 => 패키지 여러개 묶는다 => 프로젝트
 *         ------------------
 *         변수 => 배열 / 클래스
 *         메소드 => 명령문
 *         ------------------ 클래스
 ...
 *        - protected : 같은 패키지 안에서만 접근 가능, 상속시에 상속받은 클래스
 ...
 *       - 생성자 => 메소드 / 변수 사용시 메모리 저장 => 다른 클래스에서 사용 가능 : public
 *       - 클래스 => 다른 클래스에서 사용이 가능
 *       
 *       this => 객체
 *       this() => 생성자
...
public class 접근지정어_1 {
	...
	public static void main(String[] args) {
		...
		/*
		 *  this : 클래스 자신의 객체(모든 클래스 안에 존재)
		 *  ---- hong 객체와 동일
		 *  1. 생성
		 *     Sawon hone=new Sawon()
		 *  2. JVM
		 *     this=hong
		 *     
		 ...
		 */
		System.out.println("=========");
		System.out.println("사번:"+hong.getSabun()); // 출력 불가능
		System.out.println("이름:"+hong.name); // null
		System.out.println("직위:"+hong.job); // null
		System.out.println("주소:"+hong.address); // null
		
		Sawon shim=new Sawon(2,"심청이","과장","경기");
		System.out.println("shim:"+shim);
		System.out.println("사번:"+shim.getSabun());
		System.out.println("이름:"+shim.name);
		System.out.println("직업:"+shim.job);
		System.out.println("주소:"+shim.address);
	}
