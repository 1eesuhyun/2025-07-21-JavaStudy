 ...
 *                       -----------
 *                       String substring(int b)       // b부터 맨 마지막까지
 *                       String substring(int b,int e) // b부터 e까지
 *                       String[] split(String regex)
 *                                      ------------ 정규식
 *                       => 보완 : StringTokenizer
 *          • 공백문자 제거 : trim() : 좌우의 공백 제거(가운데에 있는 공백은 제거 불가능)
 *          • 비교 : equals() => boolean equals(String s)
 *          • 검색 : starthsWith(),    endsWith(),    contains()
 *                    시작 문자열(검색)  끝 문자열(확장자)     포함된 문자열
 *                    원형) boolean startsWith(String s)
 *                         boolean endsWith(String s)
 *                         boolean contains(String s)
 *          • 문자열 변환 : valueOf(기본형{int, double...})
 ...
 *        => append() : 문자열 결합
 *                  | char, String
 *        => 문자열이 많은 경우 => 문자열 결합의 최적화
 *   4) Math : only static
 *      • static double random() : 랜덤 함수
 ...
 *   8) DecimalFormat : 숫자 표현 세자리 앞에...
 *                      #,###,###,### => 오라클 : 99,999
 *            DecimalFormat d=new DicmalFormat("#,###,###")
 *   9) SimpleDateFormat : 날짜 변화
 *                   년도 : yyyy / yy
 *                   월 : MM / M
 *                       1~9
 *                       01  1
