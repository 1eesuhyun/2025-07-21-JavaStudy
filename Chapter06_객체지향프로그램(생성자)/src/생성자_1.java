 ...
 *        클래스 영역에 선언 : 인스턴스(new를 사용할때 따라 생성되는 메모리 ), 정적변수(메모리 공간 1개 => 공유변수)
 *        ** 지역변수, 매개변수 => 기본값이 없기 때문에 반드시 초기화 후 사용
 *        ** 인스턴스, 정적변수 => 기본값이 존재
 *                             int => 0
 *                             double => 0.0
 *                             boolean=> false
 *                             String => null(모든 클래스가 null)
 *        ** 변수
 ...
 *              	A(){} -> 생성자
 *              	int A(){} => 일반 메소드
 *              	void A(int a){} => 일반 메소드 :앞에 아무것도 없어야지 생성자이다
 *              	A(int a){}
 *              	A(String n){}
 *              	
 *              }
...
public class 생성자_1 {
	...
	public static void main(String[] args) {
		...
		Member m=new Member(1,"홍길동","서울","1111-1111","남자"); // 위에 값(이름 등등)을 호출
