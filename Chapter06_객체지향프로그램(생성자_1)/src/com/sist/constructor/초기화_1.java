 ...
 *                         class A
 *                         {
 *                         		int a,b,c,d; 16byte : 멤버변수
 *                         		static int e; -> 다른 메모리 공간에 저장
 *                              String name; 4byte => 4+16= 20byte 할당(모든 클래스는 4byte 메모리를 가진다)
 *                         }
 *                         this
 ...
 *           A(){}
 *           -------------
 *           void a(){}     객체명.A()  -> 앞에 리턴형 이 붙어이으면 안됌 -> 붙어이으면 일반메소드
