 ...
 *              => 데이터베이스(비동기) 비동기 : 여러가지를 동시에 처리가능
 *                  네트워크의 접속자 저장(동기) 동기 : 한번에 한가지 일만 처리가능
 *           |         |
 *       ArrayList*, Vector, LinkedList, Queue
 *     • SET형 => 순서가 없다, 데이터 중복을 허용X
 *       HashSet*, TreeSet
 *     • Map형 : 순서가 없다, (키,값) 쌍으로 되어 있다  - 클래스를 제어할때 많이 사용
...
public class 라이브러리_StringTokenizer_1 {
	...
	public static void main(String[] args) {
		...
		String colors="red,green,blue,black,yello,pink,magenta";
