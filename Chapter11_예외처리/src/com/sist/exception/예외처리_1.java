 ...
 *                            정상적으로 수행되는 부분
 *                            => 지금까지 코딩한 부분 10/0
 *                            => 출력(에러가 생기면 생긴부분부터 catch절 전까지 건너뛰고 catch절 수행후 끝)
 *                               (에러가 없으면 catch절은 수행하지 않고 수행)
 *                         }catch(예외처리 클래스)
 *                         {
 *                            에러를 잡아서 복구
 *                         }
