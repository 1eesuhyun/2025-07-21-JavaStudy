...
public class 예외처리_5 extends JFrame implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(e.getSource()==tf) // 엔터
		{
			...
			if(s==3)
			{
				int a=JOptionPane.showConfirmDialog(this,"종료?","game over", JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
				...
				else
				{
					...
					tf.setText("");
					getRand();
					JOptionPane.showMessageDialog(this, "새개임을 시작합니다");
				}
			}
		}
