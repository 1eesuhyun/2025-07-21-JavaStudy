...
public class 정리_3 {
	...
	public static void main(String[] args) {
		...
		// 배열 / Collection => 데이터 모음 JDK1.5
		// 실무 => 목록 출력시에 자주 사용
		boolean bCheck=false;
		for(String f:arr) // 향상된 for => for-each
		{
			...
			if(f.contains(fd))  //startsWith
			{
				 ...
				 *  [^A-Za-z] : 알파벳 제외
				 *  
				 *  ^[가-힣]   : 한글로 시작 ex) ^[가-힣]{3}  : 3글자로 시작하는 한글
				 *  ^[0-9]    : 숫자로 시작 ex) ^[0-9]{1,3} : 숫자가 1자리~3자리 
				 *  ^[A-Za-z] : 알파벳으로 시작
				 *  
				 *  => 파이썬 : 자연어처리
				 */
