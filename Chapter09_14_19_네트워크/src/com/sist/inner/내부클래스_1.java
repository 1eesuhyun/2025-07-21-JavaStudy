...
import com.sist.inner.Outer.Inner;

/*
 *   클래스 두개에서 공동으로 사용하는 변수, 메소드가 있는 경우에 사용
 *        ------------------------------
 *        1. 윈도우
 *        2. 쓰레드
 *        3. 네트워크
 ...
 *           public void display(){}
 *        }
 *     3) 지역 클래스 : 사용빈도는 거의 없음 => 메소드 안에 클래스 생성
 *        class A
 *        {
 *           public void display()
 *           {
...
class Outer2 
{
    ...
    Inner2 in = new Inner2(); // 내부 클래스 객체 생성
}
class Inner2
{
	public void print() 
