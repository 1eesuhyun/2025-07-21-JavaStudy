 ...
 *             }
 */
class GenieThread extends Thread // 멀티쓰레드
{
	HashSet<String> genie=new HashSet<String>(); // Set => 중복제거
	private int page=1;
	static int k=1;
	...
	public void run()
	{
		...
		{
			Document doc=
					Jsoup.connect("https://www.genie.co.kr/chart/top200?ditc=D&ymd=20250826&hh=16&rtm=Y&pg="+page).get();
			...
			for(int i=0;i<title.size();i++)
			{
				...
				genie.add(t);
				synchronized (GenieThread.class) { // synchronized : 동기화
