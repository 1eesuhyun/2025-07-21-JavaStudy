 ...
 *      - 변경후 재사용 => 상속 (is-a)
 *      1) 상속
 *         기존의 클래스(이미 만들어진 클래스)의 모든 기능과 변수르 받아서 새로운 기능의 클래스를 만든다
 *                                                             ㄴ--- 확장
 *         => 목적
 *            - 코드 재사용(소스가 간결)
 *            - 신뢰성이 뛰어나다
 ...
 *                 ------- 다중 상속 가능 : 인터페이스
 *                 
 *         => 상속내린 클래스 : 부모클래스, 슈퍼클래스, 베이스 클래스, 상위클래스
...
public class 재사용 {
	...
	public static void main(String[] args) {
		...
		sb.age=20;
		sb.name="심청이";
		System.out.println("나이:"+sb.age);
		System.out.println("이름:"+sb.name);
		sb.eat();
		sb.run();
		
		System.out.println();
		Super ss=new Sub(); // 인터페이스
		// 크기 => 상속 내린 클래스 > 상속 받은 클래스
