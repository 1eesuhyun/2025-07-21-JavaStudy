 ...
 *        7. 대입연산자
 *        
 *        자바 => JSP / SpringFramework / Spring-Boot -> 웹 라이브러리
...
public class 비교연산자 {
	...
	public static void main(String[] args) {
		...
		System.out.println("1. "+result1); //true
		System.out.println("2. "+result2); //false
		System.out.println("3. "+result3); //true
		System.out.println("4. "+result4); //true
		System.out.println("5. "+result5); //true
		
		boolean b1=true;
		boolean b2=false;
		boolean result6=(b1==b2);
		boolean result7=(b1!=b2);
		System.out.println("6. "+result6); //false
		System.out.println("7. "+result7); //true
		...
		System.out.println("8. "+result8); //false
		System.out.println("9. "+result9); //true
		System.out.println("10. "+result10); //true
		System.out.println("11. "+result11); //false
